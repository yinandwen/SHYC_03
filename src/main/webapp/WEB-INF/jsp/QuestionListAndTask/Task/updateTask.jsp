...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form" action="/Task/updateTask" method="post">
            <input type="hidden" id="TK_ID" name="TK_ID" value="${task.TK_ID}">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="TK_PRJCode" name="TK_PRJCode" required="" lay-verify="TK_PRJCode"
                           autocomplete="off"
                           class="layui-input" value="${task.TK_PRJCode}"></div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="TK_QuestionID" name="TK_QuestionID" required="" lay-verify="TK_QuestionID"
                           autocomplete="off"
                           class="layui-input" value="${task.TK_QuestionID}"></div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="TK_CODE" name="TK_CODE" required="" lay-verify="TK_CODE"
                           autocomplete="off"
                           class="layui-input" value="${task.TK_CODE}"></div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <%--<input type="text" id="L_problemType" name="problemType" required="" lay-verify="problemType"
                           autocomplete="off" class="layui-input">--%>
                    <select name="TK_Department" id="TK_Department" lay-verify="TK_Department"
                            value="${task.TK_Department}">
                        <option selected="selected" disabled>${task.TK_Department}</option>
                        <option>项目部</option>
                        <option>人事部</option>
                        <option>IT部</option>
                        <option>市场部</option>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input class="layui-input" value="<fmt:formatDate value="${task.TK_START_DATE}" pattern="yyyy-MM-dd"></fmt:formatDate>"
                           autocomplete="off"
                           name="TK_START_DATE" id="TK_START_DATE" lay-verify="TK_START_DATE">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input class="layui-input" value="<fmt:formatDate value="${task.TK_END_DATE}" pattern="yyyy-MM-dd"></fmt:formatDate>"
                           autocomplete="off"
                           name="TK_END_DATE" id="TK_END_DATE" lay-verify="TK_END_DATE">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="TK_RESPONER" name="TK_RESPONER" required="" lay-verify="TK_RESPONER"
                           autocomplete="off"
                           class="layui-input" value="${task.TK_RESPONER}"></div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <textarea class="layui-textarea" name="TK_DETAILS" lay-verify="TK_DETAILS"
                              id="TK_DETAILS">${task.TK_DETAILS}</textarea>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="TK_CREATED_BY" name="TK_CREATED_BY" required="" lay-verify="TK_CREATED_BY"
                           autocomplete="off"
                           class="layui-input" value="${task.TK_CREATED_BY}"></div>
            </div>

            <div class="layui-form-item layui-input-inline" style="padding-left: 130px;">
                <input class="layui-btn" type="submit" value="修改"<%-- onclick="xadmin.close()"--%>/></div>
